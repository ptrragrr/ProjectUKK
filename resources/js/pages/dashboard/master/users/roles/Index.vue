            ...
            <div class="d-flex align-items-center justify-content-between w-100 gap-4 flex-wrap">
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="symbol symbol-50px bg-white bg-opacity-20 rounded">
                        <i class="la la-shield-alt fs-2x text-white"></i>
                    </div>
                    <div>
                        <h2 class="text-white mb-1 fw-bold fs-1">Manajemen Roles</h2>
        ...
        <div class="card-body p-6">
            ...
            <div class="alert alert-primary d-flex align-items-center border-0 bg-light-primary mb-6" v-if="!openForm">
                ...
                <div class="text-primary">
                    ...
                    <div class="fs-7">Klik tombol "Tambah Role" untuk menambahkan role baru. Gunakan tombol aksi untuk mengedit atau menghapus role.</div>
                </div>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="position-relative">
                                ...
                                <input
                                    ...
                                    placeholder="Cari nama role atau full name..."
