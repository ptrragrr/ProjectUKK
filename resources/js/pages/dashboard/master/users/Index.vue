    ...
    <div class="card" v-else>
        ...
        >
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h2 class="mb-0 text-white fw-bold">Manajemen Users</h2>
                    <!-- <p class="mb-0 text-white opacity-75 fs-7">Kelola semua tiket konser Anda</p> -->
                </div>
            </div>
            <button
                type="button"
            ...
            <div class="alert alert-info d-flex align-items-center mb-6" style="background-color: #e8f4f8; border: 1px solid #bee5eb; border-radius: 8px;">
                ...
                <div>
                    ...
                    <p class="mb-0 text-info">
                        Klik tombol "Tambah Users" untuk menambahkan tusers. Gunakan tombol aksi untuk mengedit atau menghapus users.
                    </p>
                </div>
            </div>
