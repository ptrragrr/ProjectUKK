...
<template>
  <div class="container-fluid px-4 py-6">
      ...
      <div class="card-header bg-gradient-primary border-0 py-6 px-6">
        <div class="d-flex align-items-center justify-content-between w-100 gap-4 flex-wrap">
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              <h2 class="text-white mb-1 fw-bold fs-1">Validasi Tiket</h2>
    ...
    <div class="row mb-6">
      <div class="col-lg-8 col-xl-6 mx-auto">
        <div class="card shadow-sm border-0" style="border-radius: 12px;">
          <div class="card-header border-0 py-4" style="background-color: #e8f4f8;">
            <div class="d-flex align-items-center">
              <i class="la la-search text-info fs-2 me-3"></i>
              <h4 class="fw-bold text-info mb-0">Masukkan Kode Tiket</h4>
            </div>
          </div>
          <div class="card-body p-6">
            <div class="mb-4">
              <label for="kodeTiket" class="form-label fw-semibold text-gray-700 mb-3">
                Kode Tiket
              </label>
              <div class="position-relative">
                <i class="la la-ticket-alt position-absolute" style="left: 12px; top: 50%; transform: translateY(-50%); color: #a1a5b7; font-size: 1.25rem; z-index: 1;"></i>
                <input
                  id="kodeTiket"
                  type="text"
                  v-model="kodeTiket"
    ...
    <div v-if="errorMessage" class="row mb-6">
      <div class="col-lg-8 col-xl-6 mx-auto">
        <div class="alert alert-danger d-flex align-items-center border-0" style="border-radius: 8px;">
          <i class="la la-exclamation-circle fs-2 me-3"></i>
          <div class="flex-grow-1">
            <div class="fw-semibold">{{ errorMessage }}</div>
          </div>
          <button @click="batalCari" class="btn btn-sm btn-light-danger">
    ...
    <div v-if="transaksi" class="row">
      <div class="col-12">
        <!-- Success Banner -->
        <div class="alert alert-success d-flex align-items-center border-0 mb-6" style="border-radius: 8px;">
          <i class="la la-check-circle fs-2 me-3"></i>
          <div class="flex-grow-1">
            <h5 class="mb-1 fw-bold">Tiket Ditemukan!</h5>
            <p class="mb-0">Data tiket berhasil ditemukan dan terverifikasi</p>
          </div>
          <button @click="batalCari" class="btn btn-sm btn-light-success">
            <i class="la la-times"></i>
          </button>
        </div>
        ...
        <div class="card shadow-sm border-0" style="border-radius: 12px;">
          ...
          <div class="card-header bg-gradient-primary border-0 py-5">
            <div class="row align-items-center">
              <div class="col-md-8">
                <div class="d-flex align-items-center">
                  <div class="symbol symbol-60px bg-white bg-opacity-20 rounded me-4">
                    <i class="la la-ticket-alt fs-2x text-white"></i>
                  </div>
                  <div>
                    <h3 class="text-white fw-bold fs-2 mb-1">{{ transaksi.ticket.jenis_tiket }}</h3>
                    <p class="text-white text-opacity-75 mb-0">Kode: {{ transaksi.kode_tiket }}</p>
                  </div>
                </div>
              </div>
              <div class="col-md-4 text-md-end mt-3 mt-md-0">
                ...
                >
                  <i class="la la-check-circle me-1" v-if="transaksi.transaksi.status_payment === 'paid'"></i>
          ...
          <div class="card-body p-6">
            <div class="row g-6">
              <!-- Customer Info -->
              <div class="col-lg-6">
                <div class="bg-light-info rounded p-5 h-100" style="border-radius: 8px;">
                  <div class="d-flex align-items-center mb-4">
                    <i class="la la-user-circle text-info fs-2 me-3"></i>
                    <h5 class="mb-0 fw-bold text-info">Informasi Pembeli</h5>
                  </div>
                  
                  <div class="mb-4">
                    <label class="text-muted fs-7 fw-semibold text-uppercase mb-1">Nama Lengkap</label>
                    <div class="text-gray-900 fw-bold">{{ transaksi.transaksi.nama_pembeli }}</div>
                  </div>
                  
                  <div class="mb-4">
                    <label class="text-muted fs-7 fw-semibold text-uppercase mb-1">Email</label>
                    <div class="text-gray-900 fw-bold d-flex align-items-center">
                      <i class="la la-envelope me-2 text-muted"></i>
                      {{ transaksi.transaksi.email }}
                    </div>
                  </div>
                  
                  <div class="mb-0">
                    <label class="text-muted fs-7 fw-semibold text-uppercase mb-1">No. Telepon</label>
                    <div class="text-gray-900 fw-bold d-flex align-items-center">
                      <i class="la la-phone me-2 text-muted"></i>
              ...
              <!-- Transaction Info -->
              <div class="col-lg-6">
                <div class="bg-light-success rounded p-5 h-100" style="border-radius: 8px;">
                  <div class="d-flex align-items-center mb-4">
                    <i class="la la-money-bill-wave text-success fs-2 me-3"></i>
                    <h5 class="mb-0 fw-bold text-success">Detail Transaksi</h5>
                  </div>
                  
                  <div class="mb-4">
                    <label class="text-muted fs-7 fw-semibold text-uppercase mb-1">Kode Transaksi</label>
                    <div class="text-gray-900 fw-bold">{{ transaksi.transaksi.kode_transaksi }}</div>
                  </div>
                  
                  <div class="mb-4">
                    <label class="text-muted fs-7 fw-semibold text-uppercase mb-1">Total Pembayaran</label>
                    <div class="text-success fs-3 fw-bolder">
                      {{
                  ...
                  <div class="mb-0">
                    <label class="text-muted fs-7 fw-semibold text-uppercase mb-1">Tanggal Pembelian</label>
                    <div class="text-gray-900 fw-bold d-flex align-items-center">
                      <i class="la la-calendar me-2 text-muted"></i>
          ...
          <div class="card-footer border-0 bg-light py-4 px-6">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
              ...
              <div class="d-flex gap-3">
                <button @click="batalCari" class="btn btn-light-secondary fw-bold" style="border-radius: 8px;">
                  <i class="la la-arrow-left me-2"></i>
                  Kembali
                </button>
                <button @click="cetakTiket" class="btn btn-success fw-bold" style="border-radius: 8px;">
    ...
    <div v-if="!transaksi && !loading && !errorMessage" class="row">
      <div class="col-lg-8 col-xl-6 mx-auto">
        <div class="card border border-primary bg-light-primary" style="border-radius: 12px; border-style: dashed !important;">
          <div class="card-body p-6 text-center">
            <i class="la la-info-circle text-primary fs-2x mb-4"></i>
